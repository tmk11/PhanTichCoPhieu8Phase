...
## 1. Tóm tắt một dòng
Forward PEG (tính tay) ≈ **15.463** ⇒ KHÔNG rẻ theo tăng trưởng. Cảnh báo lớn nhất: **tăng trưởng EPS đồng thuận gần hạn ~đi ngang ⇒ PEG ngắn hạn bị méo**.
...
- **Forward PEG = 25.88 ÷ 1.67 = 15.463** (chia cho số phần-trăm-nguyên; method=manual).
...
- 🟠 **PEG ngắn hạn không đáng tin:** CAGR forward chỉ 1.67% (gần 0) ⇒ phép chia PEG phóng đại.
...
**Backlog / RPO:** Backlog Google Cloud ~462 tỷ USD cuối Q1 2026 (từ ~240 tỷ cuối Q4 2025); >50% dự kiến chuyển thành doanh thu trong 24 tháng (>230 tỷ ghi nhận tới giữa 2028). *(TIKR – Google Cloud backlog)*

**TAM còn lại:** TAM: Search/quảng cáo số, YouTube, Cloud/AI (Gemini), Waymo (AV optionality). AI vừa là cơ hội (Gemini, Cloud AI) vừa là rủi ro đối với Search truyền thống. *(heygotrade – Alphabet Q1 2026)*

**Segment & tốc độ:**
- Google Services (Search, YouTube, ads) – operating income FY2025 ~139.4 tỷ USD; Google Cloud – operating income FY2025 ~13.9 tỷ; Other Bets (Waymo...). *(Alphabet FY2025 8-K)*
...
**Forward revenue:** FY2026 ≈ 487.7 tỷ USD (data_vendor); FY2027 ≈ 578.9 tỷ USD (data_vendor).
