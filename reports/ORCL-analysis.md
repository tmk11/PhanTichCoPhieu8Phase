...
## 1. Tóm tắt một dòng
Forward PEG (tính tay) ≈ **0.6465** ⇒ tương đối RẺ so với tăng trưởng. Cảnh báo lớn nhất: **khung 4 năm KHÔNG đủ dữ liệu consensus (GAP các năm xa)**.
...
- **Forward PEG = 22.94 ÷ 35.49 = 0.6465** (chia cho số phần-trăm-nguyên, KHÔNG chia 0.xx; method=manual).
- Biến thể chỉ-dùng-data_vendor (loại nguồn news): CAGR FY2027→FY2028 = 35.49% ⇒ PEG = 0.6465.
...
- 🔴 **FCF ÂM:** -23.7 tỷ USD (Oracle FY2026 Q4 results (CNBC tổng hợp 8-K), 2026-05-31) — định giá dựa trên lợi nhuận cần thận trọng khi dòng tiền tự do âm. FCF FY2026 ÂM ~ −23.7 tỷ USD do capex 55.7 tỷ (+162%). Operating cash flow +32 tỷ (+54%) — kinh doanh lõi mạnh nhưng FCF âm vì đầu tư hạ tầng AI.
...
**Backlog / RPO:** RPO (remaining performance obligation) đạt ~638 tỷ USD cuối Q4 FY2026 (+363% YoY, +85 tỷ so với Q3); phần lớn từ hợp đồng AI quy mô lớn. BofA: >50% RPO đến từ OpenAI. *(Oracle FY2026 results / DCD / BofA, 2026-05-31)*

**TAM còn lại:** TAM hạ tầng đám mây + AI training/inference rất lớn; chiến lược multicloud (OCI chạy trong Azure/Google/AWS) + database (Oracle 23ai) mở rộng phân phối. *(Oracle IR Q3 FY2026, 2026-03-10)*

**Segment & tốc độ:**
- Cloud Services & License Support (OCI + SaaS Fusion/NetSuite) – mảng lớn nhất, tăng tốc; Cloud License & On-Premise; Hardware; Services. *(Oracle IR, 2026-06-10)*
...
**Forward revenue (consensus):** FY2027 ≈ 89 tỷ USD (40 analysts); FY2028 ≈ 129.7 tỷ USD (38 analysts).
...
---
*Sinh tự động bởi pipeline 8-phase (derive→build→verify). Recompute & guards: xem artifacts/verifier-report-ORCL.json.*
